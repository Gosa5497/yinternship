# Generated by Django 5.1.3 on 2025-04-16 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(choices=[('1', '1 Month'), ('2', '2 Months'), ('3', '3 Months'), ('6', '6 Months'), ('12', '1 Year')], default='3', max_length=3)),
                ('training_format', models.CharField(choices=[('full_time', 'Full-time'), ('part_time', 'Part-time'), ('remote', 'Remote'), ('hybrid', 'Hybrid'), ('project_based', 'Project-based')], default='full_time', max_length=20)),
                ('training_types', models.JSONField(default=list, help_text="List the specific training types (e.g., ['CCNA Certification', 'Python Programming', 'Cloud Security'])")),
                ('required_qualifications', models.JSONField(default=list, help_text='List of qualifications required for the internship.')),
                ('optional_qualifications', models.JSONField(default=list, help_text='List of optional qualifications for the internship.')),
